...
const EAT_OPTIONS = [
  {
    id: 1,
    label: 'Heel goed',
    desc: 'Ik heb geen problemen met eten.',
    color: '#B2DEB6',
    height: 71,
  },
  {
    id: 2,
    label: 'Goed',
    desc: 'Ik heb af en toe last, maar het gaat nog goed.',
    color: '#CFEBD4',
    height: 77,
  },
  {
    id: 3,
    label: 'Middelmatig',
    desc: 'Ik heb duidelijk moeite met eten, maar het lukt wel.',
    color: '#F2EFC2',
    height: 71,
  },
  {
    id: 4,
    label: 'Moeilijk',
    desc: 'Ik kan moeilijk mijn eten doorslikken.',
    color: '#F0C8AD',
    height: 71,
  },
  {
    id: 5,
    label: 'Heel moeilijk',
    desc: 'Ik kan mijn eten bijna niet doorslikken.',
    color: '#EEC7C7',
    height: 77,
  },
];

export default function DiaryVraag2Page() {
  ...
  return (
    <div style={{
      ...
      {/* ── NS-vraag+antwoord: 370×528, left:22, top:95 ── */}
      <div style={{
        position: 'absolute',
        width: '370px',
        height: '528px',
      ...
      <div style={{
        ...
        <button
          onClick={() => { saveDiaryAnswer(2, selected ?? 2); navigate('/dagboek/invullen/vraag3'); }}
          style={{
            width: '182px',
            height: '30px',
            background: '#377B8A',
