...
const PAIN_OPTIONS = [
  ...
  },
  {
    id: 2,
    label: 'Weinig pijn',
    desc: 'Ik voel het, maar het gaat.',
    color: '#CFEBD4',
    height: 77,
  },
  {
    id: 3,
    label: 'Pijn',
    desc: 'Ik voel duidelijk pijn. Maar het is nog vol te houden.',
    color: '#F2EFC2',
    height: 71,
  },
  {
    id: 4,
    label: 'Veel pijn',
    desc: 'Ik heb veel pijn.',
    color: '#F0C8AD',
    height: 71,
  },
  {
    id: 5,
    label: 'Heel veel pijn',
    desc: 'Ik heb heel veel pijn.',
    color: '#EEC7C7',
    height: 77,
  },
];

export default function DiaryVraag4Page() {
  ...
  return (
    <div style={{
      ...
      {/* ── NS-vraag+antwoord: 370×524, left:16, top:97 ── */}
      <div style={{
        position: 'absolute',
        width: '370px',
        height: '524px',
      ...
      <div style={{
        ...
        <button
          onClick={() => { saveDiaryAnswer(4, selected ?? 2); navigate('/dagboek/invullen/vraag5'); }}
          style={{
            width: '182px',
            height: '30px',
            background: '#377B8A',
