...
const BREATH_OPTIONS = [
  ...
  },
  {
    id: 2,
    label: 'Goed',
    desc: 'Ik heb af en toe moeite met ademen. Maar het gaat nog goed.',
    color: '#CFEBD4',
    height: 77,
  },
  {
    id: 3,
    label: 'Middelmatig',
    desc: 'Ik heb duidelijk moeite met ademen. Maar het lukt wel.',
    color: '#F2EFC2',
    height: 71,
  },
  {
  ...
  },
  {
    id: 5,
    label: 'Heel moeilijk',
    desc: 'Ik kan bijna niet ademen.',
    color: '#EEC7C7',
    height: 77,
  },
];

export default function DiaryVraag3Page() {
  ...
  return (
    <div style={{
      ...
      {/* ── NS-vraag+antwoord: 370×536, left:20, top:103 ── */}
      <div style={{
        position: 'absolute',
        width: '370px',
        height: '536px',
