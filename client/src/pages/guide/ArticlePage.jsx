...
const CATEGORY_DATA = {
  ...
  3: {
    ...
    tilesLeft: 20, tilesWidth: 367,
    problems: [
      { label: 'Buikkrampen', icon: 'clock_loader_10' },
      { label: 'Diarree',     icon: 'water_drops' },
      { label: 'Dumping',     icon: 'clock_loader_10' },
    ],
  },
  4: {
    ...
    tilesLeft: 20, tilesWidth: 367,
    problems: [
      { label: 'Dumping',      icon: 'clock_loader_60' },
  ...
  5: {
    ...
    tilesLeft: 20, tilesWidth: 367,
    problems: [
      { label: 'Pijn',            icon: 'heal' },
      { label: 'Gewichtsverlies', icon: 'monitor_weight' },
      { label: 'Hoesten',         icon: 'air' },
    ],
  },
};
