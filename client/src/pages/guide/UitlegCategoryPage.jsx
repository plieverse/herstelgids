...
const UITLEG_CATEGORY_DATA = {
  ...
  5: {
    ...
    description: 'Hieronder staan verhalen en ervaringen van andere patiënten.',
    icon: 'diversity_3',
    ...
    decorCircles: [
      ...
      { w: 23,  h: 23,  l: 196, t: 216 },
      { w: 15,  h: 15,  l: 216, t: 204 },
      { w: 15,  h: 15,  l: 195, t: 197 },
    ],
  ...
  6: {
    pageTitle: 'Bewegen',
    description: 'Bewegen na de operatie is belangrijk om goed te herstellen. Hieronder staat meer informatie over beweging.',
    icon: 'directions_run',
    ...
    decorColor: '#F0C8AD',
    decorCircles: [
      { w: 110, h: 110, l: 281, t: 132 },
      { w: 29,  h: 29,  l: 237, t: 169 },
      { w: 19,  h: 19,  l: 176, t: 187 },
      { w: 15,  h: 15,  l: 215, t: 197 },
    ],
    iconLeft: 260, iconTop: 118,
    tilesLeft: 17, tilesWidth: 372,
    problems: [
      { label: 'Beginnen met bewegen',       icon: 'directions_walk' },
      { label: 'Bewegen en ademhalen',        icon: 'pulmonology' },
      { label: 'Waarom bewegen belangrijk is', icon: 'directions_run' },
      { label: 'Wat je nog niet kan doen',    icon: 'close' },
    ],
  },
};
